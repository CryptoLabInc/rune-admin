...
- **Installation Scripts**:
  - Automated setup: `install.sh` (Unix) and `install.ps1` (Windows)
  - Infrastructure verification: `scripts/check-infrastructure.sh`
  - MCP server management: `scripts/start-mcp-servers.sh`
...
- **Breaking**: Requires Python 3.10+, ~4GB RAM for key generation
