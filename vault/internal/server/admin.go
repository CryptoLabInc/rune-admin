...
// UDS at v.cfg.Server.Admin.Socket with mode 0600 (umask + chmod
...
func AdminFromConfig(ctx context.Context, v *Vault) (func(context.Context) error, error) {
	...
	// Belt + suspenders: even if umask leaked, force 0600.
	...
	slog.Info("vault: admin UDS listening", "socket", socket, "mode", "0600")
