...
const (
	...
	VaultService_MarkDeleted_FullMethodName      = "/rune.vault.v1.VaultService/MarkDeleted"
	VaultService_FilterDeleted_FullMethodName    = "/rune.vault.v1.VaultService/FilterDeleted"
)
...
type VaultServiceClient interface {
	...
	MarkDeleted(ctx context.Context, in *MarkDeletedRequest, opts ...grpc.CallOption) (*MarkDeletedResponse, error)
	// Given candidate item_ids, returns the subset that is on the
	// per-index deny-list. Read scope: filter_deleted.
	FilterDeleted(ctx context.Context, in *FilterDeletedRequest, opts ...grpc.CallOption) (*FilterDeletedResponse, error)
}
...
func (c *vaultServiceClient) MarkDeleted(ctx context.Context, in *MarkDeletedRequest, opts ...grpc.CallOption) (*MarkDeletedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MarkDeletedResponse)
	err := c.cc.Invoke(ctx, VaultService_MarkDeleted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vaultServiceClient) FilterDeleted(ctx context.Context, in *FilterDeletedRequest, opts ...grpc.CallOption) (*FilterDeletedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FilterDeletedResponse)
	err := c.cc.Invoke(ctx, VaultService_FilterDeleted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VaultServiceServer interface {
	...
	// Marks item_ids as logically deleted by unioning them into the
	// per-index deny-list. Idempotent. Write scope: mark_deleted.
	MarkDeleted(context.Context, *MarkDeletedRequest) (*MarkDeletedResponse, error)
	// Given candidate item_ids, returns the subset that is on the
	// per-index deny-list. Read scope: filter_deleted.
	FilterDeleted(context.Context, *FilterDeletedRequest) (*FilterDeletedResponse, error)
...
func (UnimplementedVaultServiceServer) MarkDeleted(context.Context, *MarkDeletedRequest) (*MarkDeletedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MarkDeleted not implemented")
}
func (UnimplementedVaultServiceServer) FilterDeleted(context.Context, *FilterDeletedRequest) (*FilterDeletedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FilterDeleted not implemented")
}
...
func _VaultService_MarkDeleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkDeletedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VaultServiceServer).MarkDeleted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VaultService_MarkDeleted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VaultServiceServer).MarkDeleted(ctx, req.(*MarkDeletedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _VaultService_FilterDeleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FilterDeletedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VaultServiceServer).FilterDeleted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VaultService_FilterDeleted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VaultServiceServer).FilterDeleted(ctx, req.(*FilterDeletedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VaultService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _VaultService_MarkDeleted_Handler,
		},
		{
			MethodName: "FilterDeleted",
