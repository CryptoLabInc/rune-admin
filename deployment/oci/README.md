...
See [ARCHITECTURE.md](../../docs/ARCHITECTURE.md) for more details on the overall system.

## Next Steps

- Team setup guide: [TEAM-SETUP.md](../../docs/TEAM-SETUP.md)
- Monitor health: Setup Prometheus/Grafana
