...
// encryption, and FHE key lifecycle wrappers around the runespace SDK.
//
...
// rune and rune-console so there is no external wire-format compatibility
...
// secret and a per-agent identifier via HKDF-SHA256 (HKDF salt=None,
// info=agent_id utf-8).
