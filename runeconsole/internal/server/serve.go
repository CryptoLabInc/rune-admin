...
// Serve starts the gRPC + admin UDS listeners with the given Console and
...
func Serve(ctx context.Context, v *Console, adminFactory AdminFactory) error {
	cfg := v.Config()
...
type AdminFactory func(ctx context.Context, v *Console) (shutdown func(context.Context) error, err error)
