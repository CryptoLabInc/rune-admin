...
func AdminFromConfig(ctx context.Context, v *Console) (func(context.Context) error, error) {
	cfg := v.Config()
	...
	slog.Info("console: admin UDS listening", "socket", socket, "mode", "0660")
...
func buildAdminMux(v *Console) http.Handler {
